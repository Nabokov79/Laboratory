...
(
    ...
    date_transfer      DATE,
    document_transfer  VARCHAR,
    CONSTRAINT pk_document PRIMARY KEY (id),
    CONSTRAINT FK_DOCUMENTS_ON_HEADER_DOCUMENTS FOREIGN KEY (header_document_id)
        REFERENCES header_documents (id),
    CONSTRAINT FK_DOCUMENTS_ON_TASKS_JOURNAL FOREIGN KEY (task_journal_id)
        REFERENCES tasks_journal (id)
);
...
(
    ...
    CONSTRAINT FK_REMARKS_ON_DOCUMENT FOREIGN KEY (document_id) REFERENCES documents (id)
);
