...
@AllArgsConstructor
@NoArgsConstructor
@Schema(description = "Данные для добавления/изменения значений " +
        "норм для проведения геодезии(нивелирования) баков-аккумуляторов")
public class PermissibleDeviationsGeodesyDto {
